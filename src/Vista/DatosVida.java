 ...
 * @author Jessica
 */
public class DatosVida extends Datos{

    /**
     * 
     */
    
    public DatosVida(Interna in) 
    {
        super(in);
        initComponents();
    ...
    public static void crear_docx(String[] param,ZipOutputStream zos, File f) throws FileNotFoundException, IOException, JDOMException
    {
        ...
        else
        {
            ...
            ZipEntry entry = new ZipEntry(f.getPath().substring(12));
            zos.putNextEntry(entry);
   
            if(f.getPath().compareTo("cartas\\vida\\word\\document.xml")==0)
            {
                ...
                salida.output(documentJDOM,new FileOutputStream("cartas\\vida\\word\\document.xml"));
            }
