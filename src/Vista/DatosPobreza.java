 ...
 * @author Jessica
 */
public class DatosPobreza extends Datos{

    /**
     * 
     */
    
    public DatosPobreza(Interna in) 
    {
        super(in);
        initComponents();
    ...
    public static void crear_docx(String[] param,ZipOutputStream zos, File f) throws FileNotFoundException, IOException, JDOMException
    {
        ...
        else
        {
            ...
            ZipEntry entry = new ZipEntry(f.getPath().substring(15));
            zos.putNextEntry(entry);
   
            if(f.getPath().compareTo("cartas\\pobreza\\word\\document.xml")==0)
            {
                ...
                salida.output(documentJDOM,new FileOutputStream("cartas\\pobreza\\word\\document.xml"));
            }
    ...
    public void evento()
    {
        ...
        if(nom.compareTo("")!=0 && ced.compareTo("")!=0 && (a+m)>0)
        {
            ...
            File f = new File("cartas\\pobreza");
